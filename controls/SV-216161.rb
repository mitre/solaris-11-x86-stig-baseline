control "SV-216161" do
  title "The FTP service must display the DoD approved system use notification message or banner 
...
# echo 
\"DisplayConnect /etc/issue\" &gt;&gt; /etc/proftpd.conf
...
# svcadm restart ftp"
  ...
  tag gid: "V-216161"
  tag rid: "SV-216161r603268_rule"
  tag stig_id: "SOL-11.1-050430"
  tag fix_id: "F-17397r372866_fix"
