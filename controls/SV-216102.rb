control "SV-216102" do
  title "Graphical desktop environments provided by the system must automatically lock after 15 
...
For each existing user, check the configuration of their personal .xscreensaver 
file.
...
For each user on the system, edit their local 
$HOME/.xscreensaver file and change the timeout values.
