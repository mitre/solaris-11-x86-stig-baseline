...
kernel core dump data directory is not group-owned by a system group, the core dumps contained 
in the directory may be subject to unauthorized access."
...
In Solaris 11, 
/var/crash is linked to /var/share/crash."
...
# chgrp root 
[kernel core dump data directory]

In Solaris 11, /var/crash is linked to 
/var/share/crash."
  impact 0.5
  tag severity: "medium"
