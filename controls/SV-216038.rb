control "SV-216038" do
  title "The operating system must alert designated organizational officials in the event of an audit 
processing failure."
  desc "Proper alerts to system administrators and IA officials of audit failures ensure a timely 
response to critical system issues."
...
# newaliases"
  ...
  tag gid: "V-216038"
  tag rid: "SV-216038r603268_rule"
  tag stig_id: "SOL-11.1-010390"
  tag fix_id: "F-17274r372497_fix"
