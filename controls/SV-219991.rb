control "SV-219991" do
  title "The audit system must be configured to audit all discretionary access control permission 
modifications."
...
If \"fm\" audit 
flag is not included in output, this is a finding.

For Solaris 11.4 or newer:
# pfexec 
auditconfig -t -getflags | cut -f2 -d=

If \"fm\" audit flag is not included in output, this is a 
finding.
