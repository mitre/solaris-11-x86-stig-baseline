control "SV-216200" do
  ...
  desc "Attackers or malicious users could hide information, exploits, etc. in extended attribute 
...
Determine the existence of any files having extended file attributes, and determine the best 
course of action in accordance with site policy.

Remove the files or the extended 
attributes."
  impact 0.3
  tag severity: "low"
