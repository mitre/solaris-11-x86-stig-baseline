control "SV-216201" do
  ...
  desc "All accounts with a GID of 0 have root group privileges and must be limited to the group account 
only."
...
If the root account is not 
the only account with GID of 0, this is a finding."
  desc "fix", "The root role is required.

Change the default GID of non-root accounts to a valid GID other 
than 0."
  impact 0.5
  tag severity: "medium"
