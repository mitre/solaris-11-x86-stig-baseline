control "SV-216050" do
  title "System packages must be configured with the vendor-provided files, permissions, and 
ownerships."
...
bring configuration settings and permissions into factory compliance."
  ...
  tag gid: "V-216050"
  tag rid: "SV-216050r603268_rule"
  tag stig_id: "SOL-11.1-020080"
  tag fix_id: "F-17286r372533_fix"
