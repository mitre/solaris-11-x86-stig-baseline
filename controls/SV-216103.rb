...
If the DICTIONLIST or DICTIONDBDIR settings are not present and are 
not set to:
...
# ls -l /usr/share/lib/dict/words 
/var/passwd

If the files defined by DICTIONLIST or DICTIONBDIR are not present or are 
...
Generate 
the password dictionary by running the mkpwdict command.
...
/usr/share/lib/dict/words"
  ...
  tag gid: "V-216103"
  tag rid: "SV-216103r603268_rule"
  tag stig_id: "SOL-11.1-040190"
  tag fix_id: "F-17339r372692_fix"
