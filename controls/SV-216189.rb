control "SV-216189" do
  ...
  desc "Users within the organization must be assigned unique UIDs for accountability and to ensure 
...
Determine if there exists any users who share a common UID, and 
work with those users to determine the best course of action in accordance with site 
policy.
Change user account names and UID or delete accounts, so each account has a unique 
name and UID."
  impact 0.5
  tag severity: "medium"
