control "SV-216241" do
  ...
  desc "Tracking the specific Solaris zones in the audit trail reduces the time required to determine 
the cause of a security event."
...
The Audit 
Configuration profile is required.

Determine whether the \"zonename\" auditing policy is 
in effect.
