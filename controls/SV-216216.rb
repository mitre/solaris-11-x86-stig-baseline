...
mode of the kernel core dump data directory is more permissive than 0700, unauthorized users 
may be able to view or to modify kernel core dump data files."
...
If the directory has a mode more permissive than 0700 (rwx --- ---), 
this is a finding."
