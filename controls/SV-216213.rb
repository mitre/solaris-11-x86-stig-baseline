...
service by exhausting the available space on the target file system. The kernel core dump 
process may increase the amount of time a system is unavailable due to a crash. Kernel core 
dumps can be useful for kernel debugging."
...
# dumpadm -n"
  ...
  tag gid: "V-216213"
  tag rid: "SV-216213r603268_rule"
  tag stig_id: "SOL-11.1-080080"
  tag fix_id: "F-17449r373022_fix"
