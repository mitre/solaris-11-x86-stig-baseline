control "SV-219993" do
  title "The audit system must alert the SA when the audit storage volume approaches its capacity."
  desc "Filling the audit storage area can result in a denial of service or system outage and can lead to 
events going undetected."
...
# newaliases"
  ...
  tag gid: "V-219993"
  tag rid: "SV-219993r603268_rule"
  tag stig_id: "SOL-11.1-010370"
  tag fix_id: "F-21702r372491_fix"
